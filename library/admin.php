...
function my_login_logo_one()
{
	...
	<style type="text/css">
		.login #login h1 a {
			background: url(<?php echo get_template_directory_uri() . '/library/images/logos/logo.png'; ?>) no-repeat center !important;
			width: auto;
			height: 90px;
			margin: 0 auto;
...
// sort out media library bug in 5.5 with lazzy loading and load more added by default :(
add_filter('media_library_infinite_scrolling', '__return_true');
add_filter('wp_lazy_loading_enabled', '__return_false');
// Custom Backend Footer
function bones_custom_admin_footer()
{
	_e('<span id="footer-thankyou">Developed by <a href="http://maverickdigital.nz" target="_blank">Maverick Digital</a></span>. ', 'bonestheme');
}
