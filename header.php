			...
			<div class="wrap">
				<header id="header" class="anim header clearfix layer ">
					<div class="contact-details">
							<p><span><a href="mailto:divetatapouri@xtra.co.nz"><i class="fas fa-envelope-open-text"></i> divetatapouri@xtra.co.nz</a></span> <span><a href="tel:+64-686-85153"><i class="fas fa-phone-square-alt"></i> +64-686-85153</a></span></p>
					</div>
								...
								?>
									<li class="clearfix <?php echo $info; ?>">
										...
										<div class="inner grid inner-1170">
											<div data-aos="flip-left" data-aos-delay="1000" class="intro-copy col col-align-bottom  main-intro-heading">
												<?php if ($heading) {
													echo $heading;
												}
